<section class="py-24 bg-white font-noto overflow-hidden">
    <div class="container mx-auto px-6 relative">
        <div class="absolute -top-24 -left-24 w-96 h-96 bg-blue-50 rounded-full blur-[100px] pointer-events-none"></div>

        <div class="flex flex-col items-center text-center mb-20 relative z-10">
            <span class="text-blue-600 font-bold text-sm tracking-[0.3em] uppercase mb-4">Development Team</span>
            <h2 class="text-5xl md:text-6xl font-black text-slate-900 leading-tight">
                ผู้ร่วมพัฒนา <br>
                <span class="bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-600 bg-clip-text text-transparent">
                    กระชับมิตรกรุ๊ป
                </span>
            </h2>
            <div class="w-20 h-1.5 bg-slate-900 mt-8 rounded-full"></div>
            <p class="text-slate-500 text-lg mt-8 max-w-2xl font-anuphan leading-relaxed">
                รายชื่อผู้ร่วมพัฒนาเว็ปไซต์กระชับมิตรกรุ๊ป และตำแหน่งบทบาทภายในกระชับมิตรกรุ๊ป
            </p>
        </div>
            ...
            <div class="group flex flex-col items-center">
                ...
                <div class="text-center">
                    ...
                    <div class="flex justify-center gap-2 mt-6">
                        <a href="https://www.youtube.com/@peak4567" target="_blank"
                        ...
                        <a href="https://web.facebook.com/peak4567" target="_blank"
                        ...
                        <a href="https://www.tiktok.com/@_peak4567_" target="_blank"
                            class="w-9 h-9 flex items-center justify-center rounded-xl bg-slate-50 text-slate-400 hover:bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 hover:text-white transition-all shadow-sm"><i
                                class="fa-brands fa-tiktok text-sm"></i></a>
                    </div>
                </div>
            </div>
